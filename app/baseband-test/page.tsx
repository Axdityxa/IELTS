    ...
    In conclusion, while some aspects of cognitive function may decline with age, the brain remains remarkably adaptable. By maintaining an active mental lifestyle, managing chronic health conditions, and cultivating cognitive flexibility, it's possible to maintain and even improve mental sharpness well into old age.`,
      questions: [
        ...
        },
        {
          id: 4,
          type: 'multipleChoice',
          text: "According to the passage, which cognitive ability often improves with age?",
          options: [
            { id: 'A', text: "Processing speed" },
            { id: 'B', text: "Short-term memory" },
            { id: 'C', text: "Vocabulary" },
            { id: 'D', text: "Reaction time" }
          ]
        },
        {
          id: 5,
          type: 'multipleChoice',
          text: "What helps maintain cognitive function in later years?",
          options: [
            { id: 'A', text: "Sleeping longer hours" },
            { id: 'B', text: "Taking memory supplements" },
            { id: 'C', text: "Engaging in mentally stimulating activities" },
            { id: 'D', text: "Following a strict diet" }
          ]
        },
    ...
    As we look to the future, it's clear that preserving our agricultural heritage through seed saving will be crucial for ensuring food security and maintaining the rich tapestry of plant life on our planet. The work of dedicated individuals and organizations like the Seed Savers Exchange reminds us that sometimes, the key to our future lies in preserving the past.`,
      questions: [
        ...
        },
        {
          id: 15,
          type: 'trueFalseNotGiven',
          text: "Most nongovernment-owned seed banks are bigger than Seed Savers Exchange."
        },
        {
          id: 16,
          type: 'trueFalseNotGiven',
          text: "Diane Ott Whealy's grandfather taught her a lot about seed varieties."
        },
        {
          id: 17,
          type: 'trueFalseNotGiven',
          text: "The Seed Savers Exchange maintains records of the cultural history of seeds."
        },
        {
          id: 18,
          type: 'trueFalseNotGiven',
          text: "Climate change has no effect on seed preservation efforts."
        },
        
        // Multiple Choice Questions (19-26)
        {
          id: 19,
          type: 'multipleChoice',
        ...
        },
        {
          id: 21,
          type: 'multipleChoice',
          text: "The 'Mortgage Lifter' tomato variety is mentioned as an example of",
          options: [
            { id: 'A', text: "A failed agricultural experiment" },
            { id: 'B', text: "A historically significant plant" },
            { id: 'C', text: "A modern hybrid variety" },
            { id: 'D', text: "A commercially successful crop" }
          ]
        }
      ]
    },
    ...
    Ultimately, the decision to fluoridate water supplies often comes down to local politics and public opinion. While the scientific consensus supports the safety and effectiveness of water fluoridation, the practice remains controversial in many parts of the world. As with many public health measures, the challenge lies in balancing population-wide benefits with concerns about individual choice and potential risks.`,
      questions: [
        ...
        },
        {
          id: 28,
          type: 'multipleChoice',
          text: "One reason given by the writer for opposing fluoridation is that",
          options: [
            { id: 'A', text: "it may contribute to tooth decay" },
            { id: 'B', text: "it will be unacceptably expensive for the public." },
            { id: 'C', text: "obligatory fluoridation takes away personal freedom." },
            { id: 'D', text: "excessive fluoride could be added to the water by mistake." }
          ]
        },
        {
          id: 29,
          type: 'multipleChoice',
          text: "The writer mentions Kuhn in order to",
          options: [
            { id: 'A', text: "provide a contrast with the view of Collins." },
            { id: 'B', text: "support the notion that scientific facts are not fixed." },
            { id: 'C', text: "illustrate that paradigms can shift over time." },
            { id: 'D', text: "argue that fluoridation is based on outdated science." }
          ]
        },
        
        // Fill in the Blanks (32-35)
        {
          id: 32,
          type: 'fillInBlanks',
        ...
        },
        {
          id: 37,
          type: 'trueFalseNotGiven',
          text: "All countries that have tried fluoridation have continued the practice."
        },
        {
          id: 38,
          type: 'trueFalseNotGiven',
          text: "Severe fluorosis is common in areas with fluoridated water."
        },
        {
          id: 39,
          type: 'trueFalseNotGiven',
          text: "The fluoridation debate has become less intense in recent years."
        },
        {
          id: 40,
          type: 'trueFalseNotGiven',
          text: "Most people in the United States receive fluoridated water."
        }
      ]
    }
  ]
  ...
  return (
    <div className="min-h-screen bg-background">
      <header className="border-b p-4 flex justify-between items-center">
        ...
        <div className={`text-xl font-semibold ${timeLeft < 300 ? 'text-red-500' : ''}`}>
