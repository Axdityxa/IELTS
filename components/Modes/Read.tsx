...
export default function Component() {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col w-screen">
      <header className="border-b px-2 py-2 flex justify-between items-center w-full">
      ...
      <main className="flex-1 flex flex-col h-[calc(100vh-4rem)] w-full">
        <div className="relative mb-2 px-2">
          <Timer className="absolute left-2 top-1/2 transform -translate-y-1/2 h-5 w-5 text-primary" />
          <Progress value={(300 - timeLeft) / 3} className="h-6 ml-6" />
        </div>

        <div className="flex-1 grid grid-cols-2 gap-2 px-2 pb-2">
          <div className="h-[calc(100vh-8rem)] overflow-y-auto border rounded-lg bg-card">
            <div className="p-4">
